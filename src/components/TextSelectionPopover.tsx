        ...
        >
          ...
          >
            <motion.button
              ...
              className="flex items-center gap-1.5 rounded-lg px-3 py-2 font-mono text-[11px] tracking-wider uppercase transition-colors"
              style={{
            ...
            <motion.button
              ...
              className="flex items-center gap-1.5 rounded-lg px-2.5 py-2 font-mono text-[11px] tracking-wider uppercase transition-colors"
              style={{
                color: 'hsl(var(--steami-cyan))',
                border: '1px solid rgba(111, 168, 255, 0.15)',
                background: 'rgba(111, 168, 255, 0.05)',
